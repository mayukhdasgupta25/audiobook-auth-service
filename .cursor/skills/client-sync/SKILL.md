...
name: client-sync
description: >-
  Manually syncs the mobile app and partner-app with auth-service API changes.
...
Launch only sub-agents that have clients for the changed endpoints. Wait for both to finish.
