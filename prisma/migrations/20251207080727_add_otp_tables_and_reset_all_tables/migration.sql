...
-- CreateEnum
CREATE TYPE "OtpPurpose" AS ENUM ('LOGIN', 'REGISTRATION', 'EMAIL_UPDATE', 'PASSWORD_UPDATE');

-- CreateEnum
CREATE TYPE "EmailType" AS ENUM ('OTP', 'VERIFICATION', 'PASSWORD_RESET', 'WELCOME', 'NOTIFICATION');
...
-- CreateIndex
CREATE UNIQUE INDEX "otp_tokens_codeHash_key" ON "otp_tokens"("codeHash");
